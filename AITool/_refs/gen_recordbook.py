...
def gen_recordbook():
    ...
    para(doc, "项目一 · 第3讲：刁难任务卡·第二轮｜课件 07", 14, True, (0xBF, 0x36, 0x0C))
    pause_block("⑦", "让 AI 找全错：加了哪几句", 5,
                "你给 AI 的命令里，加了哪几句它才把错找全？哪一处错，AI 最容易漏？",
                deck="07")
    pause_block("⑧", "一条干三件，还是拆开", 8,
                "一条命令干三件事，和三条命令各干一件事——哪种更好使？为什么？",
                deck="07")
    para(doc, "✅ 下课前自查：□⑦我写出了找全错的关键句　□⑧我说清了哪种更好使　"
              "□今天三个任务我做过了：＿＿个　　两招：干不动就拆开 / 拿不准让它自己查", 11)
    ...
    doc.save(os.path.join(OUT_DIR, f"03_我的AI实验记录_全程_v1.5_20260909.docx"))
    print("saved 03")
