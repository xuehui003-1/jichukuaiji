...
OUT = "05_机器人实验记录册_全程_v2.9_20260918.docx"
NUM = "①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑮⑯⑰⑱⑲⑳㉑㉒㉓㉔㉕㉖㉗㉘㉙㉚㉛"
...
pause("⑦", "08", "从「看图认命令」五条里挑 2 条，各拆成三要素：动作／参数／输出。")
grid(["弹什么", "什么时候弹", "弹给谁"])
...
P("必做③（p18/p26）：智多星建档课上没建完的——十二个货＋你自己的 5 个变量（xingMing/xueHao/nianLing/yiFuYanSe/daiYanJing），课下补齐，下次课开场查。", 10)
grid(["补齐自查：十二货□　个人5个□"])
...
pause("㉔", "16", "没做作业的抽备用场景卡（打印/奶茶/食堂/开水房，卡上有三个数和答案），照卡先猜再跑三个数；做了的用自己作业。")
...
pause("㉘", "17", "没做作业的抽备用卡（打印/奶茶/食堂/开水房，卡上有三个数和答案），照卡先猜再跑三个数；做了的用自己作业。")
