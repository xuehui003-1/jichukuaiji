...
grid(["我定的宿舍规矩"])
P("选做（p57）：找一块学校里「满 X 减 Y」或「第二件半价」的招牌，抄下价目带来贴黑板。", 10)
grid(["我抄的招牌价目"])
P("🗓 大任务（p57，一周，+5 分）：画一张「我的省钱图纸」——①挑一个你在学校真花钱的场景（食堂套餐/打印店/奶茶）；②问清价目写在图纸旁；③照外卖计算器画三行图纸；④开头 2 人一组互验：同桌按你图纸口头跑一遍，算对了他签字。老师查三行＋签字，抽 2 人投屏讲。", 10)
grid(["我的场景和价目", "第 1 行 变量", "第 2 行 命令", "第 3 行 串法", "同桌签字（他跑对了）"])
...
grid(["我带来的报错词"])
P("🏁 项目二大任务（p21，一周，+5 分）：本周生活费记账机器人——①每天记 1 行流水（花什么、多少钱），预算自己定（例 500）；②照「余额格」画图纸：每笔「生活费＝生活费−这一笔」；③低于 100 弹「该省省了」；④下次进机房照图纸当场真跑给老师看。流水 7 行＋当场跑通＝满分。", 10)
