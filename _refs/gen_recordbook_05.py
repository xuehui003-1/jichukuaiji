...
grid(["我的想法", "思考过程", "老师的讲解"])
P("✏️ 课堂记录 · 它一声不吭做了几个主？　——课件 04 · p23", 11.5, True, "1A5276", 10, 2)
P("AI 把名单整理得整整齐齐——但它一声不吭替你定了几件事？把「主」抓出来；再用一条「收主命令」把要求说死（下节课开头发给 AI 验收）。", 9.5, False, "555555", 0, 3)
grid(["它自己定的 ①", "它自己定的 ②", "它自己定的 ③", "我的收主命令（下节课原样发）"])
selfcheck("□①我写出了意外　□②③④我写了规矩　□我抓出了它的主＋写了收主命令　　我猜错最惨的：＿＿＿＿＿＿＿＿＿＿＿＿")
