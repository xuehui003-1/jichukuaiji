...
REVISION_HISTORY = [
    ("v1.2", "2026-09-04",
     "删除「照片：基础会计课已交过的不再交」——两门课程面向不同学生，不存在已交照片；其余题目不变。"),
    ("v1.1", "2026-09-04",
     "16/17 题改为「班级连续剧」角色问答：用选角色的方式间接收集彩蛋意愿与画风偏好，"
     "让学生在不知不觉中回答，避免直接提问的尴尬；其余题目不变。"),
    ("v1.0", "2026-09-03",
...
para("我的互审搭档（同桌）签名：＿＿＿＿＿＿＿＿", size=10.5, space_after=8)
...
q("16　这学期我们的课会像一部「连续剧」：重点知识会演成小剧场、小漫画，班里可能出现一个「很像你」的角色。你想怎么出场？",
  "□ 主角团成员——给我设计专属形象，正式出镜\n□ 客串演员——先露个脸试试看\n□ 场外指导——幕后出主意，不出镜\n□ 忠实观众——只围观，不参与")
q("17　假如这部剧里有一个「很像你」的角色，你希望它是什么画风？（不管第 16 题怎么选，都想象一下）",
  "□ 我的翻版（保留我的样子和几个小特点）\n□ 次元联动（和我喜欢的动画人物同框）\n□ 表情包担当（做成适合当头像/表情包的样子）\n□ 剧情担当（画成有趣的上课场景）\n□ 导演决定（根据我前面的回答自由发挥）")
q("18　做得好，想要什么奖励（可多选）：",
