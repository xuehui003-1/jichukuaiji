...
v2.2 生活化改版：不涉及财务共享中心等深奥专业概念；全用生活例子引入；
「规矩实验室」做实做深（认领机器写规矩 + 洗衣机意外大讨论 + 快问快答 + 手机十年后想象）；
...
make_table(
    ...
    [
        ...
        ("33–36", "生活入口：它们都在照规矩干活",
         "洗衣机＝选模式、转多久；扫地机＝没电回充；售货机＝投币→选货→出货；点破“这些规矩都是人写的——今天，你来写”",
         "听＋补充家里的例子", "从家里的事进门，不恋战"),
        ("36–39", "规矩实验室·任务发布＋各自写",
         "同桌认领一台机器（洗衣机/售货机/扫地机），每人写 3 条规矩，全部写成「如果…就…」；教师巡场",
         "认领机器＋写规矩", "人人当总工程师"),
        ("39–41", "拆洗衣机·热身（全班范例）",
         "快洗→15分钟、标准洗→45分钟、脱水→3分钟；学生说、老师板书写「如果…就…」",
         "说规矩", "「如果…就…」句式上口"),
        ("41–46", "暂停点①（记录册第 1 页）",
         "洗到一半突然停电，来电后洗衣机该怎么做？先写你的规矩；不公布答案",
         "90 秒安静写", "用例外情况练条件思维；先猜后讲"),
        ("46–51", "抽人②：念停电规矩",
         "抽 2–3 人念；点评哪条机器能执行、哪条会闹笑话（参考：记下洗到哪一步→来电接着洗；或提示“已断电，请重选程序”）",
         "念＋听点评", "立规矩：写了就敢说"),
        ("51–56", "洗衣机意外大讨论＋抽人③",
         "四种意外每种 1 分钟：加衣服/忘洗衣液/塞太多/没人拿——全班提规矩，板书写「如果…就…」（参考答案见教学备忘）",
         "提规矩", "例外越多，条件理解越深"),
        ("56–59", "售货机＋扫地机快问快答",
         "卡币/找零不够/出货卡住；卡门槛/楼梯边/没电——抢答，不抽人",
         "抢答", "简单题不抽人，形成对比"),
        ("59–63", "手机·十年后＋抽人④",
         "先吐槽手机最烦人的 3 个毛病，再想象 10 年后的新规矩（例：晚上 11 点自动免打扰）；抽 2–3 人说一条",
         "吐槽＋想象", "跳脱思维，探索能力"),
        ("63–64", "收束",
         "聪明程度＝规矩数量×质量；「如果…就…」是条件、「一直/几遍」是循环——今天先混个脸熟，项目二、三正式学；好规矩记入班级「规矩宝典」",
         "听", "概念落点"),
        ("64–69", "AI 铺垫＋任务发布",
...
para("时间合计：8+10+10+5+3+3+2+5+5+5+3+4+1+5+10+5+2+2+2 = 90 分钟。",
     size=10, bold=True, space_before=4)
para("抽人共 6 处（①定档念问卷 ②停电规矩 ③意外讨论 ④手机想象 ⑤当指挥演示 ⑥收尾复述），"
     "全部对应课件的「🎲 抽人」标识；快问快答与热身环节一律抢答不抽人。",
...
for t in [
    ...
    ("概念 2　三种最基本的“规矩”（正式术语后面再学）",
     ...
     "本课用洗衣机的各种意外（停电、加衣服、忘洗衣液、没人拿）反复练「如果…就…」：例外越多，规矩越多。"),
    ("概念 3　变量＝机器人装东西的盒子",
...
make_table(
    ...
    [
        ...
        ("A2 指挥初体验\n难度★★",
         ...
         "提示：说清楚「干什么＋怎么算干好」。\n彩蛋：胜组获「首席指挥官」称号"),
        ("A3 给机器立规矩\n难度★★★",
         "同桌认领一台机器（洗衣机/售货机/扫地机），写 3 条「如果…就…」规矩；全班评选「最严总工程师」",
         "提示：先想意外情况，再写规矩。\n彩蛋：最佳规矩记入班级「规矩宝典」（一学期积累，期末打印成册）"),
    ],
...
for s in [
    ...
    "时间超支：规矩实验室每种意外限 1 分钟，超时砍「手机·十年后」挪到课后选做；「学生当指挥」压到 1 组；「财务里也有这种活」缩到 2 分钟。",
    "抽人冷场：被抽者答不出，同桌补答，第一课不扣分、不批评——先让学生不怕被抽。",
    "洗衣机意外参考答案（学生说不出时逐步提示）：停电→记下洗到哪一步、来电接着洗，或提示「已断电，请重选程序」；"
    "加衣服→水位降到安全线→开锁→加衣服→重新加水→继续；忘洗衣液→泡沫检测不到→蜂鸣提醒「未检测到洗涤剂，是否继续」；"
    "塞太多→重量超标→报警并拒绝启动；没人拿→蜂鸣提醒 2 次→每隔 10 分钟抖散一次防皱→超过 1 小时自动关舱门。",
    "手机环节冷场：先让全班举手吐槽（它最烦人的 3 个毛病），气氛起来再想象 10 年后；"
